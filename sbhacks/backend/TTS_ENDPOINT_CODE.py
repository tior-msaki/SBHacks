"""
Add this code to your app.py file to enable ElevenLabs text-to-speech
"""
...
# Add this model class with other Pydantic models
...
# Add this endpoint function with your other endpoints
